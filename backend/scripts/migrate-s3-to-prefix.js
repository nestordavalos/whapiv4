 ...
 *
 * Usage: node scripts/migrate-s3-to-prefix.js [--dry-run]
 */
...
async function checkTargetExists(client, targetKey) {
  try {
    await client.send(
...
async function migrateObject(client, sourceKey, targetKey) {
  try {
