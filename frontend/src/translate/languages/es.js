    ...
    translations: {
      ...
      connections: {
        ...
        toasts: {
          ...
          syncing: "Sincronizando mensajes no leídos...",
          ...
          reused: "La conexión fue recreada internamente. Escanea el nuevo código QR.",
        },
        confirmationModal: {
          ...
          reuseTitle: "Reutilizar conexión",
          reuseMessage: "Se eliminará todo el estado interno de Zapo y se generará una sesión completamente nueva con el mismo ID y configuración. Los contactos, tickets y mensajes de la aplicación no se eliminarán. ¿Deseas continuar?",
        },
        buttons: {
          ...
          reuse: "Reutilizar instancia",
          reusing: "Recreando...",
          tempBanned: "Bloqueo temporal",
        },
        status: {
          BANNED: "Cuenta bloqueada",
          TEMP_BANNED: "Bloqueo temporal",
        },
        details: {
          reason: "Motivo",
        },
        accountType: {
          label: "Cuenta",
          personal: "WhatsApp personal",
          business: "WhatsApp Business",
        },
        zapoHealth: {
          title: "Alcance a chats nuevos",
          used: "Usados",
          available: "Disponibles",
          renews: "El ciclo se renueva:",
          pausedUntil: "Pausa hasta:",
          pauseRemaining: "Restan:",
          ...
          personalQuota: "La cuenta personal no reporta un cupo numérico",
          quotaNotReported: "WhatsApp no informó un cupo numérico",
          cappingDisabled: "Zapo informa que el cupo numérico no está habilitado para esta cuenta",
          configuredLimit: "Cupo obtenido de la configuración sincronizada por Zapo",
          ...
          status: {
            ...
            paused: "Pausado",
            unknown: "Salud no informada",
            notReported: "Sin cupo informado",
          },
        },
        disconnectReasons: {
          failure_banned: "WhatsApp bloqueó permanentemente la cuenta",
          failure_temp_banned: "WhatsApp restringió temporalmente la cuenta",
          failure_locked: "La cuenta está bloqueada",
          failure_not_authorized: "WhatsApp revocó la autorización. Reutiliza la instancia y escanea un QR nuevo",
          failure_client_too_old: "La versión del cliente ya no es compatible",
          failure_bad_user_agent: "WhatsApp rechazó el tipo de cliente",
          failure_service_unavailable: "El servicio de WhatsApp no está disponible",
          stream_error_device_removed: "El dispositivo fue desvinculado desde WhatsApp",
          stream_error_force_logout: "WhatsApp forzó el cierre de la sesión",
          stream_error_replaced: "La sesión fue reemplazada por otra conexión",
          client_disconnected: "La sesión fue desconectada localmente",
          unknown: "WhatsApp cerró la sesión sin indicar un motivo",
        },
        syncMenu: {
          unread: "Mensajes no leídos",
          unreadDesc: "Solo sincroniza mensajes no leídos (rápido)",
          all: "Todos los mensajes",
          allDesc: "Recupera mensajes históricos del dispositivo",
        },
        empty: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          webhookEventConnectionHealth: "Salud y alcance de la conexión",
          ...
          // Sync configuration
          syncTitle: "Configuración de Sincronización",
          syncDescription: "Configura cómo esta conexión sincroniza mensajes del dispositivo. Los cambios se aplican en la próxima sincronización.",
          syncLimits: "Límites de Sincronización",
          syncMaxMessagesPerChat: "Mensajes por chat",
          syncMaxMessagesPerChatDesc: "Máximo de mensajes a sincronizar por cada conversación",
          syncMaxChats: "Chats a procesar",
          syncMaxChatsDesc: "Número máximo de chats a sincronizar por sesión",
          syncMaxMessageAgeHours: "Antigüedad máxima",
          syncMaxMessageAgeHoursDesc: "Solo sincroniza mensajes más recientes que este tiempo",
          syncDelayBetweenChats: "Delay entre chats",
          syncDelayBetweenChatsDesc: "Tiempo de espera entre cada chat para no sobrecargar el sistema",
          syncBehavior: "Comportamiento",
          syncMarkAsSeen: "Marcar como leído",
          syncMarkAsSeenDesc: "Marca los mensajes sincronizados como leídos en WhatsApp",
          syncCreateClosedForRead: "Tickets cerrados para leídos",
          syncCreateClosedForReadDesc: "Los mensajes ya leídos crean tickets en estado cerrado/resuelto",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      syncConfig: {
        ...
        infoMessage: "Configura los parámetros de sincronización de mensajes. Los cambios se aplican inmediatamente sin necesidad de reiniciar el servidor.",
        toasts: {
          saved: "Configuración de sincronización guardada con éxito",
        },
        limits: {
          title: "Límites de Sincronización",
          maxMessagesPerChat: "Mensajes por chat",
          maxMessagesPerChatDesc: "Máximo de mensajes a sincronizar por cada conversación",
          maxChats: "Chats a procesar",
          maxChatsDesc: "Número máximo de chats a sincronizar por sesión",
          maxMessageAgeHours: "Antigüedad máxima",
          maxMessageAgeHoursDesc: "Solo sincroniza mensajes más recientes que este tiempo",
          delayBetweenChats: "Delay entre chats",
          delayBetweenChatsDesc: "Tiempo de espera entre cada chat para no sobrecargar el sistema",
        },
        behavior: {
          title: "Comportamiento",
          markAsSeen: "Marcar como leído",
          markAsSeenDesc: "Marca los mensajes sincronizados como leídos en WhatsApp",
          createClosedForRead: "Tickets cerrados para leídos",
          createClosedForReadDesc: "Los mensajes ya leídos crean tickets en estado cerrado/resuelto",
        },
        buttons: {
