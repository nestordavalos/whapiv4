  ...
  es: {
    translations: {
      ...
      settings: {
        ...
        settings: {
          embed: {
            title: "Acceso embebido",
            createTitle: "Nueva integración",
            editTitle: "Editar integración",
            listTitle: "Integraciones creadas",
            description: "Genera accesos revocables para dominios autorizados usando los permisos del usuario seleccionado.",
            name: "Nombre de la integración",
            origins: "Dominios autorizados",
            originsHelp: "Un origen por línea, por ejemplo https://portal.empresa.com",
            ...
            cancel: "Cancelar",
            empty: "Todavía no hay integraciones embebidas.",
            required: "Completa el nombre, el usuario y al menos un dominio.",
            saved: "Integración guardada.",
            copied: "Copiado al portapapeles.",
            copyError: "No se pudo copiar al portapapeles.",
            copyUrl: "Copiar URL",
            copyCode: "Copiar iframe",
            dynamicHelp: "Para una ruta dinámica agrega, por ejemplo: &next=%2Ftickets%2F123 al final de la URL.",
            edit: "Editar",
            rotate: "Rotar clave",
            delete: "Eliminar",
            rotateConfirm: "La URL anterior dejará de funcionar. ¿Continuar?",
            deleteConfirm: "¿Eliminar esta integración? La URL dejará de funcionar.",
            rotated: "Clave rotada. Utiliza la nueva URL.",
      ...
      backendErrors: {
        ...
        ERR_INVALID_EMBED_ORIGIN: "El dominio debe ser un origen HTTPS válido y no puede incluir rutas.",
        ERR_INVALID_EMBED_PATH: "La ruta inicial no está permitida.",
        ERR_INVALID_EMBED_NAME: "El nombre de la integración no es válido.",
        ERR_EMBED_INTEGRATION_NOT_FOUND: "La integración embebida no existe o está desactivada.",
        ERR_EMBED_ORIGIN_NOT_ALLOWED: "Este dominio no está autorizado para usar la integración.",
        ERR_INVALID_EMBED_TOKEN: "La clave de acceso embebido no es válida.",
        ERR_EMBED_SESSION_REVOKED: "La sesión embebida fue revocada.",
